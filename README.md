...
<h3 align="center">Mern Stack Developer | Competitive Programmer | DSA Enthusiast | C++ Coder</h3>

- 🎓 Final year student at IIIT Bhopal, ECE Department  
- 👨‍💻 Passionate about web development and efficient problem-solving  
- 💻 Solved 1000+ DSA problems across LeetCode, Codeforces, CodeChef, and GFG  
...
## 🌐 Connect with me: [![LinkedIn](https://img.shields.io/badge/-LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/pappu-kumar-4ab414232/)
...
- 🔹 **Job Portal MERN Stack App**  
  A full-featured job board for recruiters and job seekers  
  _Tech: React, Node, MongoDB, Express, Cloudinary_

- 🔹 **Code Optima**  
  A code review tool powered by Gemini API  
  _Tech: React, Node.js, Express, OpenAI/Gemini_
